...
(
  ...
  output logic [24:0] tag_array_read_out_0, tag_array_read_out_1
);
  ...
  generate
    if ( p_num_banks == 1 ) begin
      ...
      assign mk_addr_evict = {tag_array_read_out, cachereq_addr_reg_out[6:4], 4'b0};
    end
      ...
      assign mk_addr_refill = {cachereq_addr_reg_out[31:4], 4'b0};
      assign mk_addr_evict = {tag_array_read_out[22:0], cachereq_addr_reg_out[8:6], cachereq_addr_reg_out[5:4], 4'b0};
    end
  endgenerate
  ...
  logic [127:0] data_array_read_out, data_array_read_out_0, data_array_read_out_1;
  ...
  logic [1:0] tag_array_wen_way;
  logic [24:0] tag_array_read_out;

  assign tag_array_read_out = way_sel ? tag_array_read_out_1 : tag_array_read_out_0;
  assign tag_array_wen_way[0] = tag_array_wen && (way_sel == 1'b0);
  assign tag_array_wen_way[1] = tag_array_wen && (way_sel == 1'b1);

  logic [1:0] data_array_wen_way;

  assign data_array_write_in = write_data_from_mem ? memresp_data : cachereq_data_replicated;
  assign data_array_read_out = way_sel ? data_array_read_out_1 : data_array_read_out_0;
  assign data_array_wen_way[0] = data_array_wen && (way_sel == 1'b0);
  assign data_array_wen_way[1] = data_array_wen && (way_sel == 1'b1);
  ...
  (
    ...
    .read_data     (tag_array_read_out_0),
    .write_en      (tag_array_wen_way[0]),
  ...
  (
    ...
    .reset         (reset),
    .read_addr     (cachereq_addr_index),
    .read_data     (data_array_read_out_0),
    .write_en      (data_array_wen_way[0]),
  ...
  (
    ...
    .reset         (reset),
    .read_addr     (cachereq_addr_index),
    .read_data     (tag_array_read_out_1),
    .write_en      (tag_array_wen_way[1]),
    .read_en       (tag_array_ren),
    .write_addr    (cachereq_addr_index),
    .write_data    (cachereq_addr_tag)
  );
  ...
  (
    ...
    .reset         (reset),
    .read_addr     (cachereq_addr_index),
    .read_data     (data_array_read_out_1),
    .write_en      (data_array_wen_way[1]),
    .read_en       (data_array_ren),
    .write_byte_en (wben_decoder_out),
    .write_addr    (cachereq_addr_index),
    .write_data    (data_array_write_in)
