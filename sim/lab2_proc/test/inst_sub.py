...
def gen_src1_dep_test():
  return [
    gen_rr_src1_dep_test( 5, "sub", 1, 13, -12 & 0xffffffff ),
    gen_rr_src1_dep_test( 4, "sub", 1, 14, -13 & 0xffffffff ),
    gen_rr_src1_dep_test( 3, "sub", 1, 15, -14 & 0xffffffff ),
    gen_rr_src1_dep_test( 2, "sub", 1, 16, -15 & 0xffffffff ),
    gen_rr_src1_dep_test( 1, "sub", 1, 17, -16 & 0xffffffff ),
    gen_rr_src1_dep_test( 0, "sub", 1, 18, -17 & 0xffffffff ),
  ]
