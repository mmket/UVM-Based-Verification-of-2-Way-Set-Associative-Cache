...
(
  ...
  input logic br_cond_blt,
  input logic br_cond_bltu,
  ...
  output logic imul_req_val_D,   // imul request valid
  input logic imul_req_rdy_D,  // imul request ready

  input logic imul_resp_val_X,   // imul response valid
  output logic imul_resp_rdy_X,    // imul response ready

  // memory control port

  output logic [1:0] dmem_sel_X,
  ...
  localparam br_jal = 3'd2;
  localparam br_jalr = 3'd3;
  localparam br_beq = 3'd4;
  ...
  always_comb begin
    ...
    casez ( inst_D )
      ...
      `TINYRV2_INST_MUL     :cs( y, br_na,  imm_x, y, bm_rf,  y, alu_mul, nr, wm_a, y,  n,   n    );
      ...
      `TINYRV2_INST_JAL     :cs( y, br_jal,  imm_j, y, bm_x,   n, alu_cp0, nr, wm_a, y,  n,   n    );
      `TINYRV2_INST_JALR    :cs( y, br_jalr, imm_i, y, bm_imm, n, alu_add, nr, wm_a, y,  n,   n    );

      `TINYRV2_INST_BNE     :cs( y, br_bne,  imm_b, y, bm_rf,  y, alu_br,  nr, wm_a, n,  n,   n    );
...
always_comb begin
  ...
  assign stall_X = val_X && ( ostall_X || ostall_M || ostall_W || ostall_imul_X);
